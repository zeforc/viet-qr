...
{#if isOpen}
  ...
  <div class="vqr-overlay" role="dialog" aria-modal="true" on:click|self={closeModal}>
    <div class="vqr-modal">
      <button class="vqr-modal__close" aria-label="Đóng" on:click={closeModal}>✕</button>
